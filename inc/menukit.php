...
class edge_merger_Menukit {
	 ...
	 *
	 * @global 		 			$edge_merger_themekit 			Themekit class
	 *
	 * @param 		string 		$item_output		//
	 * @param 		object 		$item				//
	 * @param 		int 		$depth 				//
	...
	public function menu_caret( $item_output, $item, $depth, $args ) {
		...
		$output .= $item->title;
		$output .= '<span class="children">' . $edge_merger_themekit->get_svg( 'caret-down' ) . '</span>';
		$output .= '</a>';
	...
	public function get_svg_by_class( $classes ) {
		...
		foreach ( $classes as $class ) {
			...
			$check = $edge_merger_themekit->get_svg( $class );
 ...
 */
$edge_merger_menukit = new edge_merger_Menukit();
