 ...
 */
	function edge_merger_posted_on() {
	...
	} // edge_merger_posted_on()
endif;



if ( ! function_exists( 'edge_merger_entry_footer' ) ) :
/**
 * Prints HTML with meta information for the categories, tags and comments.
 */
	function edge_merger_entry_footer() {
 ...
 * @return bool
 */
function edge_merger_categorized_blog() {

	if ( false === ( $all_the_cool_cats = get_transient( 'edge_merger_categories' ) ) ) {
		...
		set_transient( 'edge_merger_categories', $all_the_cool_cats );

	}

	if ( $all_the_cool_cats > 1 ) {

		// This blog has more than 1 category so edge_merger_categorized_blog should return true.
		return true;

	} else {

		// This blog has only 1 category so edge_merger_categorized_blog should return false.
		return false;

	}

} // edge_merger_categorized_blog()
